    ...
    return (
      <div className="container">
        ...
        <Jumbotron
          ...
          instructions="Search for a book; then view it on Google Books, or add it to your Book Collection..."
          image="https://fisher.library.utoronto.ca/sites/fisher.library.utoronto.ca/files/fisher_3.jpg"
        />
        <SearchForm
