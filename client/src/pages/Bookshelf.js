    ...
    return (
      <div className="container">
        <Jumbotron
          ...
          instructions="View your book at Google, or remove it from your Book Collection..."
          image="https://speakenglishsalon.files.wordpress.com/2010/08/the-university-club-library.jpg"
        />
        <BookCard
